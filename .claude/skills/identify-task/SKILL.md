...
9. **Exit** - show summary of each step from this skill, expecially codex validation and user validation, and the final task brief. Ask the user if they want to save it to `docs/tasks/<slug>.md` (yes/no). If yes, save it; if no, discard it.
