...
- Clarify which documents should remain in the configured document set; Peter said to keep only a specified set, but the message ended before the list, so no removals should be inferred yet (requested 2026-07-27T20:16:09Z; unresolved as of 2026-07-27T20:16:16Z).
