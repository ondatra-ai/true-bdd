...
## A Developer should have the implement-task skill refine its plan, end-to-end test implementation, and final solution through Codex critique loops grounded in the task goal and plan, incorporating every suggestion rated 7/10 or higher for relevance and stopping when none remain or after five rounds.
