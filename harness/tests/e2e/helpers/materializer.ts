 ...
 * (tests/harness/materializer — see its doc.go for the CLI contract,
...
/** Resolves a fixture name to `harness/tests/e2e/fixtures/<name>`. */
export function fixtureDir(name: string): string {
  return path.join(suiteContext().harnessDir, "tests", "e2e", "fixtures", name);
}
 ...
 * preparation failure.
 *
 * @param nameOrDir fixture name (resolved against tests/e2e/fixtures)
