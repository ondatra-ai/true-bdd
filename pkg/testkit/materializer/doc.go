...
// suite's TypeScript helper, since deleted, and shares its
// primitives — engine-layer overlay, tree copy, checklist prompt
// filtering — with the BDD fixture runner (pkg/testkit/runner) instead
...
//   - semantics shared with pkg/testkit/runner via runner.FilterChecklistFile.
package main
